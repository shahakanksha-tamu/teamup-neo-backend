...
# Projects
projects = [
  { name: 'Project Gamma', description: 'Gamma project description', objectives: 'Complete the gamma phase', status: 'active', start_date: Date.new(2024, 11, 15), end_date: Date.new(2025, 1, 31) },
  { name: 'Project Delta', description: 'Delta project description', objectives: 'Complete the delta phase', status: 'active', start_date: Date.new(2024, 11, 15), end_date: Date.new(2025, 1, 31) },
  { name: 'Project Epsilon', description: 'Epsilon project description', objectives: 'Complete the epsilon phase', status: 'active', start_date: Date.new(2024, 11, 15), end_date: Date.new(2025, 1, 31) }
]
...
tasks_gamma = [
  ...
  { task_name: 'Gamma Milestone 2 Task 4', description: 'Description for Gamma Milestone 2 Task 4', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Gamma Milestone 2').id, deadline: Date.new(2024, 12, 15) },
  { task_name: 'Gamma Milestone 2 Task 5', description: 'Description for Gamma Milestone 2 Task 5', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Gamma Milestone 2').id, deadline: Date.new(2024, 12, 15) },
  { task_name: 'Gamma Milestone 3 Task 1', description: 'Description for Gamma Milestone 3 Task 1', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Gamma Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Gamma Milestone 3 Task 2', description: 'Description for Gamma Milestone 3 Task 2', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Gamma Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Gamma Milestone 3 Task 3', description: 'Description for Gamma Milestone 3 Task 3', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Gamma Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Gamma Milestone 3 Task 4', description: 'Description for Gamma Milestone 3 Task 4', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Gamma Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Gamma Milestone 3 Task 5', description: 'Description for Gamma Milestone 3 Task 5', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Gamma Milestone 3').id, deadline: Date.new(2024, 12, 31) }
]
...
tasks_delta = [
  ...
  { task_name: 'Delta Milestone 2 Task 4', description: 'Description for Delta Milestone 2 Task 4', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Delta Milestone 2').id, deadline: Date.new(2024, 12, 15) },
  { task_name: 'Delta Milestone 2 Task 5', description: 'Description for Delta Milestone 2 Task 5', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Delta Milestone 2').id, deadline: Date.new(2024, 12, 15) },
  { task_name: 'Delta Milestone 3 Task 1', description: 'Description for Delta Milestone 3 Task 1', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Delta Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Delta Milestone 3 Task 2', description: 'Description for Delta Milestone 3 Task 2', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Delta Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Delta Milestone 3 Task 3', description: 'Description for Delta Milestone 3 Task 3', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Delta Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Delta Milestone 3 Task 4', description: 'Description for Delta Milestone 3 Task 4', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Delta Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Delta Milestone 3 Task 5', description: 'Description for Delta Milestone 3 Task 5', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Delta Milestone 3').id, deadline: Date.new(2024, 12, 31) }
]
...
tasks_epsilon = [
  ...
  { task_name: 'Epsilon Milestone 2 Task 4', description: 'Description for Epsilon Milestone 2 Task 4', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Epsilon Milestone 2').id, deadline: Date.new(2024, 12, 15) },
  { task_name: 'Epsilon Milestone 2 Task 5', description: 'Description for Epsilon Milestone 2 Task 5', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Epsilon Milestone 2').id, deadline: Date.new(2024, 12, 15) },
  { task_name: 'Epsilon Milestone 3 Task 1', description: 'Description for Epsilon Milestone 3 Task 1', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Epsilon Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Epsilon Milestone 3 Task 2', description: 'Description for Epsilon Milestone 3 Task 2', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Epsilon Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Epsilon Milestone 3 Task 3', description: 'Description for Epsilon Milestone 3 Task 3', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Epsilon Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Epsilon Milestone 3 Task 4', description: 'Description for Epsilon Milestone 3 Task 4', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Epsilon Milestone 3').id, deadline: Date.new(2024, 12, 31) },
  { task_name: 'Epsilon Milestone 3 Task 5', description: 'Description for Epsilon Milestone 3 Task 5', status: 'Not Started', milestone_id: Milestone.find_by(title: 'Epsilon Milestone 3').id, deadline: Date.new(2024, 12, 31) }
]
