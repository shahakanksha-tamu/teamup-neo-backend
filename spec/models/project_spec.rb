...
RSpec.describe Project, type: :model do
  describe 'associations' do
    it 'has many student assignments' do
      association = Project.reflect_on_association(:student_assignments)
    ...
    it 'has many milestones' do
      association = Project.reflect_on_association(:milestones)
      expect(association.macro).to eq(:has_many)
      expect(association.options[:dependent]).to eq(:destroy)
    end

    it 'has one timeline' do
      association = Project.reflect_on_association(:timeline)
