...
# Allow real network connections for non-calendar tests
Before('not @calendar') do
  WebMock.allow_net_connect!
end

# Reset WebMock after each scenario tagged with @calendar
After('@calendar') do
  WebMock.reset!
end

# Disable real network connections after non-calendar tests
After('not @calendar') do
  WebMock.disable_net_connect!(allow_localhost: true)
end
